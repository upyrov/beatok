...
export function Knob({
	...
	useHotkey("ArrowUp", (e) => updateValue(e, valueRef.current + 1), {
		target: knobRef,
	});
	useHotkey("ArrowRight", (e) => updateValue(e, valueRef.current + 1), {
		target: knobRef,
	});
	useHotkey("ArrowDown", (e) => updateValue(e, valueRef.current - 1), {
		target: knobRef,
	});
	useHotkey("ArrowLeft", (e) => updateValue(e, valueRef.current - 1), {
		target: knobRef,
	});
	useHotkey("PageUp", (e) => updateValue(e, valueRef.current + 10), {
		target: knobRef,
	});
	useHotkey("PageDown", (e) => updateValue(e, valueRef.current - 10), {
		target: knobRef,
	});
